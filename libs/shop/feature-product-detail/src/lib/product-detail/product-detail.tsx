...
import { ProductDetailsCard } from '../product-detail-card/product-details-card';
...
export function ProductDetail() {
	...
	return <ProductDetailsCard getStars={getStars} handleAddToCart={handleAddToCart} handleBackClick={handleBackClick} product={product} key={"product_card"} />
